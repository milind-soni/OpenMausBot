...
// reads ASTRA_DATA_DIR at import time — so point the suite at a scratch dir
...
// ASTRA_DATA_DIR is set by the harness. Here we isolate by botId.
...
beforeEach(() => {
  ...
  process.env.ASTRA_TEST_UNUSED = scratch; // keep cleanup symmetrical
