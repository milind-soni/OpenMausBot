...
// here, above the roomHandoffs construction, so later module-level consumers
// bind its drains in declaration order; runGroupMemberTurn and startTurn are
// wrapper thunks over function declarations this file hoists below.
const {
