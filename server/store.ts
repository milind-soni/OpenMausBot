...
export class Store {
  ...
  constructor(defaultSelection: () => ModelSelection) {
    ...
    this.internals = {
      ...
      deleteThreadRecord: (threadId) => this.deleteThreadRecord(threadId),
  ...
  /** Swap a machine-made first-message channel title for a generated one, once. */
  retitleGroupTask(groupId: string, threadId: string, machineTitle: string, title: string) {
  ...
  /** Delete one thread's durable record; routing through the Store keeps
   * cross-slice deletion observable to overrides and spies. */
  deleteThreadRecord(threadId: string): void {
    messageOps.deleteThreadRecord(this.internals, threadId);
  }
  ...
  retitleTask(botId: string, threadId: string, machineTitle: string, title: string) {
