// Skill text rules — the agentskills.io SKILL.md subset this store
// accepts (name and description limits, frontmatter parsing) and the
// static warning scan shown on the review surface.
