...
import { turnResources, turnComputerResources } from "./turn-admission.ts";
...
export interface WorkflowWiringDeps {
  ...
  vpsThreadStarted: EngineWiring["vpsThreadStarted"];
  vpsThreadEnded: EngineWiring["vpsThreadEnded"];
  turnHandoffs: EngineWiring["handoffs"];
  reportIncident: EngineWiring["reportIncident"];
...
const {
  ...
  startTurn: {
    ...
    computers: {
      ...
      vpsThreadStarted: deps.vpsThreadStarted,
      vpsThreadEnded: deps.vpsThreadEnded,
    },
    prompts: {
...
const {
  ...
  wiring: {
    ...
    helpers: {
      ...
      handoffs: deps.turnHandoffs, reportIncident: deps.reportIncident,
