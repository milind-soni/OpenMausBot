...
export function createEventFold(deps: EventFoldDeps) {
  ...
  function wireEventFold(): void {
    ...
    bus.subscribe(runtimeEventRouter({
      ...
      pokeScreenPoller, routines, localVmThreadTargets, handoffs, lastReply,
      ...
      completions: turnCompletionHandlers({
        ...
        releaseLocalVmThread, vpsThreadEnded, releaseTurnResources,
        ...
        groupSpeakers, finalizeDelegationWatch, reportIncident, routines,
      }),
    }));
