...
private let log = Logger(subsystem: "com.astra.companion", category: "stream")
...
final class Session: ObservableObject {
    ...
    private func restore() {
        ...
        registry = AstraSharedConnectionStore.loadRegistry()
        connections = registry.connections
    ...
    private func commitPairing(_ stored: Connection, token: String, winner: CompanionEndpoint? = nil) throws {
        ...
        CompanionPairingCommitSequence.persist {
            ...
            AstraSharedConnectionStore.saveRegistry(updatedRegistry)
        }
    ...
    /// `GET /.well-known/astra/environment` on a server about to be
    ...
    private static func confirmServer(at connection: Connection) async throws {
        ...
        do {
            ...
            throw APIError.transport(
                "\(connection.displayAddress) isn't an Astra server. Check the address and try again."
            )
        }
    }
    ...
    private func persistRegistry() {
        AstraSharedConnectionStore.saveRegistry(registry)
    }
        ...
        do {
            ...
            if attachments.contains(where: { $0.kind == .image }) {
                ...
                do {
                    ...
                    actionError = "Update Astra on this computer before sending images."
                    return false
                }
    ...
    nonisolated private static func materializePreview(
        ...
        let root = manager.temporaryDirectory
            .appendingPathComponent("AstraFilePreviews", isDirectory: true)
