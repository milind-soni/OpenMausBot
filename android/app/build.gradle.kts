...
//     ASTRA_KEYSTORE_FILE, ASTRA_KEYSTORE_PASSWORD,
//     ASTRA_KEY_ALIAS, and optionally ASTRA_KEY_PASSWORD.
//
...
private val storeFilePath = signingMaterial("storeFile", "ASTRA_KEYSTORE_FILE")
private val storePasswordValue = signingMaterial("storePassword", "ASTRA_KEYSTORE_PASSWORD")
private val keyAliasValue = signingMaterial("keyAlias", "ASTRA_KEY_ALIAS")
...
private val keyPasswordValue =
    signingMaterial("keyPassword", "ASTRA_KEY_PASSWORD") ?: storePasswordValue
...
private val releaseSigningMaterial = mapOf(
    "storeFile / ASTRA_KEYSTORE_FILE" to storeFilePath,
    "storePassword / ASTRA_KEYSTORE_PASSWORD" to storePasswordValue,
    "keyAlias / ASTRA_KEY_ALIAS" to keyAliasValue,
)
...
android {
    namespace = "com.astra.companion"
    compileSdk = 37

    defaultConfig {
        applicationId = "com.astra.companion"
        minSdk = 26
        targetSdk = 37
