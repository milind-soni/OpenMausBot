...
import com.astra.companion.core.ConnectedAppsRules
import com.astra.companion.core.ConnectorAccount
import com.astra.companion.core.ConnectorCard
import com.astra.companion.core.ConnectorCatalog
import com.astra.companion.core.ConnectorStatus
import com.astra.companion.core.ConnectorStatuses
        ...
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(6.dp)) {
            ...
            Text(
                if (hasLastKnownInventory) {
                    "Showing what was connected last time. Your computer could not open its credential store just now, so these accounts could not be re-checked. Nothing has been disconnected — restarting Astra on your computer usually clears this."
                } else {
                    "Your computer could not open its credential store, so it cannot say which accounts are connected. Nothing has been disconnected — restarting Astra on your computer usually clears this."
                },
                color = secondaryTint,
                fontSize = 13.sp,
            )
