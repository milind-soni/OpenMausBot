...
If your company uses OpenMaus Admin, you can sign in with your organisation to use the AI models it provides, alongside your own. It is optional. See [Use OpenMausBot at work](./organisation.mdx).
