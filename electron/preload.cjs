...
const bridge = {
  ...
  sttSettings: () => ipcRenderer.invoke("stt:settings"),
  sttSave: (config) => ipcRenderer.invoke("stt:save", config),
  sttInstall: (request) => ipcRenderer.invoke("stt:install", request),
  sttPickEngine: () => ipcRenderer.invoke("stt:pick-engine"),
  sttBegin: () => ipcRenderer.invoke("stt:begin"),
  sttCancel: (id) => ipcRenderer.invoke("stt:cancel", id),
  sttTranscribe: (request) => ipcRenderer.invoke("stt:transcribe", request),
  sttVoiceTyping: () => ipcRenderer.invoke("stt:voice-typing"),
