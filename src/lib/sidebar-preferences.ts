...
export const SIDEBAR_DENSITY_KEY = "astra.sidebarDensity";
export const SIDEBAR_COLLAPSED_SECTIONS_KEY = "astra.sidebarCollapsedSections.v1";
export const SIDEBAR_SECTION_ORDER_KEY = "astra.sidebarSectionOrder.v1";
