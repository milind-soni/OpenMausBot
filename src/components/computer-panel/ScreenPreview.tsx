  ...
  return (
    <>
          ...
          <div className="mb-1.5 mt-2 flex items-center justify-between text-[13px] text-ink-secondary">
            ...
            {currentTeamComputer && <span className="text-[11px]">{t("computer.teamDefault")}</span>}
        ...
        <div className="relative flex aspect-[16/10] w-full items-center justify-center overflow-hidden rounded-xl bg-card">
          {cloudPreviewReady || (bot.computer === "cloud" && phase === "starting") ? (
            ...
            <div className="flex flex-col items-center gap-2 px-6 text-center text-ink-secondary">
              ...
              {currentTeamComputer && <>
                <p className="text-[12px]">{t("computer.teamBox.sharedNote")}</p>
                <button type="button" onClick={onShowTeamMap}
                  className="mt-1 rounded-lg bg-control px-3 py-1.5 text-[12px] text-ink hover:bg-raised-hover">{t("computer.teamBox.openMap")}</button>
                <button type="button" onClick={onRefreshStatus}
                  className="text-[11px] text-ink-secondary hover:text-ink">{t("computer.teamBox.refreshStatus")}</button>
              </>}
