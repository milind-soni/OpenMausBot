...
/** Resolved per call, not once at import: this is what someone reads before
 * letting a bot act on their computer unattended. */
export const localComputerAutoWarning = () => t("localAuto.body");
