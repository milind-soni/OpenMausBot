...
import type { OverlayKind, OverlaySection } from "./overlays";
import type { AppState } from "./reducer";
import type { Bot, BotAnnouncement, BotProject, ConfigStatus, Group, InstanceInfo, Message, ModelSelection, ProjectUpdatePatch, TaskUpdatePatch } from "./model";
