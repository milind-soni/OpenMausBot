...
import { StoreProvider, useStore, overlayOpen } from "../../src/state/store";
...
function Preview() {
  ...
  return <>
    ...
    {onboarding ? <WelcomeFlow bot={null} initialBeat="engines" replay onDone={() => setOnboarding(false)} /> : overlayOpen(state, "appSettings") && <SettingsModal />}
