/**
 * The catalog outlines, as absolute cubic path data.
 *
...
/** A broad cloud with soft upper lobes and a rounded lower edge. */
function buildCloud(): string {
  return new Path()
    .moveTo(50, 180)
    .curveTo([22, 180, 0, 158, 0, 131])
    .curveTo([0, 109, 13, 90, 33, 84])
    .curveTo([37, 82.8, 39, 79, 39, 75])
    .curveTo([39, 54, 56, 37, 77, 37])
    .curveTo([81, 37, 84, 35.5, 87, 31])
    .curveTo([101, 10, 133, 15, 143, 39])
    .curveTo([145, 43.8, 148, 45, 153, 45])
    .curveTo([177, 45, 195, 63, 195, 87])
    .curveTo([195, 93, 197, 99, 201, 104])
    .curveTo([213, 119, 208, 145, 190, 156])
    .curveTo([185.5, 158.75, 182, 162, 178, 167])
    .curveTo([165.2, 183, 145, 188, 127, 179])
    .curveTo([121, 176, 115, 176, 109, 179])
    .curveTo([91, 188, 69, 180, 50, 180])
    .close()
}
...
/** Outlines in persisted order. Append new bodies so existing picker positions stay stable. */
export const BODY_DEFS: BodyDef[] = [
  ...
  { id: "pill", name: "Pill", d: buildRoundedBox(200, 134, 67), viewBox: [0, 0, 200, 200] },
  { id: "wedge", name: "Wedge", d: buildPolygon(200, 230, 3, 0.42), viewBox: [0, 0, 200, 200] },
  { id: "cloud", name: "Cloud", d: buildCloud(), viewBox: [0, 0, 200, 200] },
]
