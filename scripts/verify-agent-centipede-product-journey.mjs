...
const result = await runProductJourneyHost({ repoRoot, stateRoot, outputDir, mode: "verify" });
process.stdout.write(`${JSON.stringify({ passed: result.passed, output: "artifacts/centipede-0.2.0/benchmark/journey/verify-result.json" })}\n`);
