...
const resources = process.env.ASTRA_CUA_RESOURCES ?? join(root, "dist-native", hostArch);
process.env.ASTRA_CUA_SDK_LIBRARY = join(resources, "cua-sdk/native/libcua_driver_sdk.dylib");
...
const host = new EmbeddedCuaDriverHost(binary, "com.astra.app");
let proxy;
...
try {
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "astra-package-smoke", version: "1" },
  });
