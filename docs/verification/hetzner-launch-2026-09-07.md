...
Baseline: published `astra@0.1.60`, main `3ec6dbcd`. Runtime fixes were
...
```text
systemctl is-enabled astra.service: enabled
systemctl is-active astra.service: active
NRestarts=0
codex login status: Logged in using ChatGPT
kernel.apparmor_restrict_unprivileged_userns = 1
control-astra doctor: ok=true, packaged=true, availableEngines=[codex]
```
...
Codex was signed out on the VPS, and Astra logout confirmed the managed
