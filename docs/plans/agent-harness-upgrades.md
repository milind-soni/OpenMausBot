# Astra harness implementation plan
...
(pi, agent-orchestrator, deepseek-harness) and asking what Astra lacked by
...
**The reframe that reorders everything.** Astra is itself a harness. The
...
**On-disk forward compatibility.** `~/.astra` is shared across app versions.
